...
const TRAVEL_STYLES = [
  ...
  { id:"direct",    icon:"🎯", title:"Direct",    desc:"Prioritize speed and the simplest connection." },
...
const COUNTRIES = [
  ...
  {code:"SG",name:"Singapore"},{code:"AE",name:"United Arab Emirates"},{code:"AU",name:"Australia"},
  ...
  {code:"IN",name:"India"},{code:"TH",name:"Thailand"},{code:"VN",name:"Vietnam"},
  ...
  {code:"MX",name:"Mexico"},{code:"ZA",name:"South Africa"},{code:"EG",name:"Egypt"},
  {code:"TR",name:"Turkey"},{code:"RU",name:"Russia"},{code:"SA",name:"Saudi Arabia"},
  {code:"QA",name:"Qatar"},{code:"IE",name:"Ireland"},{code:"PT",name:"Portugal"},
  {code:"PL",name:"Poland"},{code:"GR",name:"Greece"},{code:"IL",name:"Israel"},
...
const ACCOMMODATION_OPTIONS = [
  ...
  { value:"airport-only",   label:"Airport only" },
  { value:"none",           label:"No accommodation needed" },
  { value:"flexible",       label:"Flexible" },
];

/* =============================================================
   通用胶囊切换组（用于 Yes/No 及 二选一 偏好）
   ============================================================= */
...
function PreferencePage({ onBack, onSubmit }) {
  const [form, setForm] = useState({
    ...
    allowSelfTransfer: null,
    allowAirportChange: null,
    accommodationPreference: "",
    connectionPace: "relaxed",
  });
  ...
  return (
    <div className="pref-page">
      ...
      <div className="pref-container">
        ...
        <section id="profile" className="pref-section sketch-card">
          ...
          <div className="pref-form-grid pref-form-grid--3">
            ...
            <div className="form-field">
              ...
              <input className="form-input" type="text" list="passport-country-list"
                placeholder="Search country... e.g. United States"
                value={form.passportCountry} onChange={e => update("passportCountry", e.target.value)}/>
              <datalist id="passport-country-list">
                {COUNTRIES.map(c => <option key={c.code} value={`${c.name} (${c.code})`}/>)}
              </datalist>
            </div>
          </div>
        </section>
        ...
        {/* ── Section 5: Trip Logistics ── */}
        <section className="pref-section sketch-card">
          <div className="pref-section__icon">🧭</div>
          <h2 className="pref-section__title">Trip Logistics</h2>
          <p className="pref-section__desc">A few practical questions that help us filter and score your connections.</p>
          <div className="pref-form-grid">
            <div className="form-field">
              <label className="form-label">Willing to self-transfer (re-check bags &amp; re-clear security) to save money?</label>
              <PillToggle
                options={[{value:true,label:"Yes"},{value:false,label:"No"}]}
                value={form.allowSelfTransfer}
                onChange={v => update("allowSelfTransfer", v)}/>
            </div>
            <div className="form-field">
              <label className="form-label">Willing to transfer between different airports in the same city?</label>
              <PillToggle
                options={[{value:true,label:"Yes"},{value:false,label:"No"}]}
                value={form.allowAirportChange}
                onChange={v => update("allowAirportChange", v)}/>
            </div>
            <div className="form-field">
              <label className="form-label">Where would you be comfortable resting during a stopover?</label>
              <select className="form-input" value={form.accommodationPreference}
            ...
            <div className="form-field">
              <label className="form-label">Do you want extra time during layovers, or the bare minimum?</label>
              <PillToggle
                options={[{value:"minimum_legal",label:"Bare minimum"},{value:"relaxed",label:"Extra time"}]}
                value={form.connectionPace}
                onChange={v => update("connectionPace", v)}/>
            </div>
          </div>
        </section>
